...
const SEED_PRODUCTS = [
  {
    id: "p1", category: "smart", name: "Trilock Freestyle", model: "FX-200",
  ...
  {
    id: "p2", category: "smart", name: "Trilock Mode", model: "MD-100",
  ...
  {
    id: "p3", category: "smart", name: "Trilock Liberty", model: "LB-300",
  ...
  {
    id: "p4", category: "smart", name: "Trilock Haven", model: "HV-150",
  ...
  {
    id: "p5", category: "levers", name: "Lever Set — Round Rose", model: "LR-RR-01",
  ...
  {
    id: "p6", category: "deadbolts", name: "Deadbolt — Single Cylinder", model: "DB-SC-02",
  ...
  {
    id: "p7", category: "mortice", name: "Mortice Lock — Privacy Set", model: "ML-PR-03",
  ...
  {
    id: "p8", category: "patio", name: "Patio Bolt Set", model: "PB-SL-04",
  ...
  {
    id: "p9", category: "entrance", name: "Entrance Set — Knob & Deadbolt Combo", model: "ES-KD-05",
  ...
  {
    id: "p12", category: "spares", name: "Latch & Strike Plate — Standard", model: "LS-STD-60",
  ...
  {
    id: "p10", category: "spares", name: "Pull Handle — Stainless 300mm", model: "PH-SS-300",
  ...
  {
    id: "p11", category: "bolts", name: "Flush Bolt Set", model: "FB-12",
...
function EntryFormModal({ initial, onClose, onSave }) {
...
export default function App() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((p) => {
      ...
      if (!q) return true;
      const haystack = [p.name, p.model, p.description, ...(p.tags || []), ...(p.finishes || []), ...Object.values(p.specs || {})]
        .join(" ").toLowerCase();
      return haystack.includes(q);
    });
        ...
        {tab === "products" ? (
          <>
            ...
            <div className="flex gap-2 overflow-x-auto pb-3 mb-3 -mx-1 px-1">
              {CATEGORIES.filter((c) => c.id !== "policy").map((c) => (
                <button
                  key={c.id}
      ...
      {selectedProduct && (
        <>
          ...
          >
            <div className="border-b-4 border-amber-700 bg-stone-900 text-white px-5 py-4 flex items-start justify-between">
              <div>
                <div className="text-[11px] uppercase tracking-wide font-semibold" style={{ color: "#d6a85c" }}>{categoryLabel(selectedProduct.category)}</div>
